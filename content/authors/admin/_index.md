...
Hi, Emanuele here! I am a researcher in computer science at the [High-Performance Computing Laboratory](http://hpc.isti.cnr.it/) of the [Institute of Information Science and Technologies](https://www.isti.cnr.it) of the [National Research Council of Italy (CNR)](https://www.cnr.it/en). My research lies at the intersection of decentralized systems and graph analysis, which we apply to application orchestration and resource management for Cloud-Edge platforms. I am also tinkering with temporal community detection with GNNs. Active on [European-funded projects](https://ecarlini.github.io/personal-website/#projects).
